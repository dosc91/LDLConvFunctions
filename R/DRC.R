#' Dual Route Consistency - DRC
#'
#' @description \code{DRC} computes the correlation between the semantic vector estimated from the direct route
...
#' \itemize{
#'   \item \code{DRC} - The DRC value of a word.
...
DRC <- function (comprehension, Shat_matrix_indirect, data)
{
